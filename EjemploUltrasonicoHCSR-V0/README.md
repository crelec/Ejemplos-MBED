En este ejemplo se presenta el driver para el sensor ultrasónico **HC-SR04** el cual Implementa la señal **Trigger Input** para iniciar la medida de distancia y verifica la
